  ...
  Widget build(BuildContext context) {
    ...
    final Widget startDatePicker = RawMaterialButton(
      ...
      child: Text(
        ...
        style: const TextStyle(fontWeight: FontWeight.w500, color: defaultTextColor),
        ...
        Container(
          ...
          child: ListTile(
            leading: Container(
              ...
              child: const Icon(Icons.access_time, size: 20, color: defaultColor),
            ),
            title: _isAllDay
                ? Row(
        ...
        Container(
          ...
          child: ListTile(
            leading: Container(
              width: 30,
              alignment: Alignment.centerRight,
              child: const Icon(Icons.location_on, color: defaultColor, size: 20),
            ),
            title: TextField(
              ...
              keyboardType: TextInputType.multiline,
              maxLines: null,
              style: const TextStyle(fontSize: 15, color: defaultTextColor),
              decoration: const InputDecoration(
                filled: true,
        ...
        Container(
          ...
          child: ListTile(
            leading: Container(
              width: 30,
              alignment: Alignment.centerRight,
              child: const Icon(Icons.subject, size: 20, color: defaultColor),
            ),
            title: TextField(
          ...
          Container(
            ...
            child: ListTile(
              leading: Container(
                width: 30,
                alignment: Alignment.centerRight,
                child: const Icon(Icons.people, color: defaultColor, size: 20),
              ),
